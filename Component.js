jQuery.sap.declare("ZINE.Component");
jQuery.sap.require("sap.ui.core.routing.Router");
jQuery.sap.require("ZINE.Router");
sap.ui.core.UIComponent.extend("ZINE.Component", {
	metadata: {
		name: "ZINE",
		version: "1.0",
	...
	init: function() {
		...
		var rootPath = jQuery.sap.getModulePath("ZINE");
