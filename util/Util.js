 ...
 */
jQuery.sap.declare("ZINE.util.Util");
ZINE.util.Util = {
	...
	getAppOfflineInterface: function() {
		if (new ZINE.util.AppOfflineInterface().isOffline()) {
			jQuery.sap.require("ZINE.util.AppOfflineInterface");
			return new ZINE.util.AppOfflineInterface();
		}
	}
};