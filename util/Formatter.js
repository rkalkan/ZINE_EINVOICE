jQuery.sap.declare("ZINE.util.Formatter");
...
ZINE.util.Formatter = {
	...
	setApplicationFacade: function(a) {
		ZINE.util.Formatter._applicationFacade = a
	},
	uppercaseFirstChar: function(sStr) {
		return sStr.charAt(0).toUpperCase() + sStr.slice(1);
	},
	getResourceBundle: function() {
		return ZINE.util.Formatter.getApplicationFacade().getResourceBundle()
	},
	getApplicationFacade: function() {
		return ZINE.util.Formatter._applicationFacade
	},
	...
	formatQuantity: function(v, u) {
		...
		var a = q.format(v);
		return ZINE.util.Formatter.getResourceBundle().getText("QUANTITY_UNIT", [a, u])
	},
	...
	quantity: function(v, a) {
		var b = ZINE.util.Formatter.formatQuantityEdit(v, a);
		return b + " " + a;
	},
	...
	resetFooterContentRightZINE: function(c) {
