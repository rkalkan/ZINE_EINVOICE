jQuery.sap.require("ZINE.util.Formatter");
jQuery.sap.require("sap.m.MessageBox");
jQuery.sap.require("sap.m.MessageToast");
jQuery.sap.declare("ZINE.util.Validation");
jQuery.sap.require("ZINE.Component");
sap.ui.controller("ZINE.view.Detail", {
	...
	oFormatter: ZINE.util.Formatter,
	onInit: function() {
	...
	productTableWithNewModel: function() {
		...
		o.read("/InvoiceMasterSet('" + that.RefNo + "')/Item", {
			...
			error: function(e) {
				...
				ZINE.util.Validation.showMsgBox(o.error.message.value, "E");
			}
